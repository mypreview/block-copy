...
if ( ! class_exists( 'Block_Copy' ) ) :
    ...
    final class Block_Copy {
        ...
        public function editor_enqueue() {
            ...
            $script_path       = sprintf( '%sassets/dist/script.js', BLOCK_COPY_DIR_PATH );
            $script_asset_path = sprintf( '%sassets/dist/script.asset.php', BLOCK_COPY_DIR_PATH );
            $script_asset      = file_exists( $script_asset_path ) ? require $script_asset_path : array(
                'dependencies' => array( 'wp-blocks', 'wp-dom-ready' ),
                'version'      => filemtime( $script_path ),
            );
            $script_url        = sprintf( '%sassets/dist/script.js', BLOCK_COPY_DIR_URL );
            // Enqueue the script.
